      ...
      <Card className="p-6 backdrop-blur-xl bg-white/40 border border-white/30 shadow-2xl">
        <div className="flex items-center justify-between">
          <div className="space-y-2">
            ...
            <div className="flex items-center space-x-4 text-sm text-gray-700 pl-1 flex-wrap">
              ...
              <Badge variant="secondary" className="backdrop-blur-md bg-white/60 text-black border border-white/40 px-3 py-1 shadow-lg">
                {report.metadata?.strategyName || 'LLM Generated Analysis'}
              </Badge>
              {report.metadata?.fallback && (
                <Badge variant="secondary" className="backdrop-blur-md bg-yellow-100 text-yellow-800 border border-yellow-400 px-3 py-1 shadow-lg">
                  Fallback Mode
                </Badge>
              )}
            </div>
